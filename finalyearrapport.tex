...
Le chapitre suivant, \textbf{«\,Préparation du Projet\,»}, formalise les besoins, la méthodologie de développement \textbf{en spirale} par cycles successifs et les environnements techniques retenus pour mener à bien la réalisation de KODA.
  ...
  \IfFileExists{public/block1-serpapi-search-music.png}{%
	...
	KODA vise une relation d'accompagnement personnalisée~: le robot doit \textbf{reconnaître}
	l'interlocuteur, \textbf{se souvenir} des échanges passés et \textbf{répondre} de
	manière adaptée, que l'utilisateur s'exprime à voix haute ou via son téléphone. Or
	ces capacités ne peuvent pas être confiées à un seul composant~: la réflexion
	conversationnelle, la mémoire durable, la voix et la vision mobilisent des briques
	techniques distinctes, hébergées à des endroits différents. Sans médiateur, le système
	manquerait de \textbf{cohérence}~: chaque interaction risquerait d'être isolée, chaque
	composant devrait connaître tous les autres, et l'évolution du projet deviendrait
	fragmentée.
